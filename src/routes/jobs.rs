use crate::{cacheable::CacheAble, requests::ManualJobTrigger, stats::JobStatus, AppState};
...
pub async fn get_jobs(
...
) -> crate::errors::ErrorWrapper<impl IntoResponse> {
    ...
    crate::errors::ErrorWrapper::Ok((StatusCode::OK, serde_json::to_string(&jobs)?))
}
